...
class Tasks extends CI_Controller { 
	...
	/*
	* Function Created for R of Tasks Crud
	*/
    public function show($id){
        ...
        $data['is_complete'] = $this->Task_model->check_if_complete($id);
       	...
       	// echo '<pre>';print_r($data);die(__FILE__.'<hr>'.__FUNCTION__);
    ...
    /*
	* Function Created for C of Tasks Crud
	*/
    ...
    /*
    * Function Created for U of Tasks Crud
    */
    ...
    /*
    * Function Created for D of Tasks Crud
    */
