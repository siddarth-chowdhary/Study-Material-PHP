...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jobeet', 'user' => 'root', 'password' => 'tech', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Siddarth/JobeetBundle/Resources/config/doctrine') => 'Siddarth\\JobeetBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Login/LoginBundle/Resources/config/doctrine') => 'Login\\LoginBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($a, 'Siddarth\\JobeetBundle\\Entity');
        $c->addDriver($b, 'Login\\LoginBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SiddarthJobeetBundle' => 'Siddarth\\JobeetBundle\\Entity', 'LoginLoginBundle' => 'Login\\LoginBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_84f3c47a63ea2e82bbb779abde75ae312d5b3470c68633756028cfc7fd46ad41');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '33e29c4dc13f7866dcfe7d23d567436feedf673b');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Siddarth/JobeetBundle/Resources/views'), 'SiddarthJobeet');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('33e29c4dc13f7866dcfe7d23d567436feedf673b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SiddarthJobeetBundle' => 'Siddarth\\JobeetBundle\\SiddarthJobeetBundle',
            ...
            'locale' => 'en',
            'secret' => '33e29c4dc13f7866dcfe7d23d567436feedf673b',
            ...
            'kernel.secret' => '33e29c4dc13f7866dcfe7d23d567436feedf673b',
