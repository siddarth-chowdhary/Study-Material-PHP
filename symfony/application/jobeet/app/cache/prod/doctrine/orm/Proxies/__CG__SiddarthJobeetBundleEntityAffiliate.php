 ...
 */
class Affiliate extends \Siddarth\JobeetBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'id', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'url', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'email', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'token', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'created_at', '' . "\0" . 'Siddarth\\JobeetBundle\\Entity\\Affiliate' . "\0" . 'category_affiliates');
        }
