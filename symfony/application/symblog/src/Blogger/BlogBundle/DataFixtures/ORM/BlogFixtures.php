...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog6 = new Blog();
        $blog6->setTitle('Added By Siddarth on 12 August 2014');
        $blog6->setBlog('Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque.');
        $blog6->setImage('custom.jpg');
        $blog6->setAuthor('Siddarth Chowdhary');
    ...
    /* priority/order of getting blogs is 1 , comments is 2.*/        
